...
const getData = async (event) => {
 ...
 if(subRegions === 'null'){
  ...
  data.map(data => data.countries.Spain.regions.map(data =>{
    ...
    } else if(regions === 'madrid') { return log.innerHTML = `Casos confirmados: ${dataConfirmed} <br><br> Fallecidos: ${dataDeaths} <br><br> Para que vas a ir ahí figura? Si hablan mazo raro y tienen todos los garitos chapados`
  } else { 
